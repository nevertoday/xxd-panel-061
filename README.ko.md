...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 061 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 061 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 061 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 061 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 061 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 061 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 061 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 061 additional top-bottom sample 4"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 061 left-right sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 061 left-right sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 061 left-right sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 061 left-right sample 4"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 061 top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 061 top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 061 top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 061 top-bottom sample 4"></td>
  </tr>
</table>
...
여행, 모임, 일상을 담은 한 장의 사진에서 차마 버릴 수 없는 것은 대개 하나의 주인공만이 아닙니다. 어떤 동작, 작은 물건 하나, 주변 환경, 사람들 사이의 관계가 모두 기억의 일부일 수 있습니다. 흔한 단일 주제 일러스트는 이런 단서를 놓치기 쉽고, 똑같이 칸을 나눈 콜라주는 소재 목록처럼 보이기 쉽습니다.

**Panel 061**은 가장 의미 있는 단서 3–6개를 서로 호응하는 기억의 조각으로 다시 엮습니다. 사진의 핵심 관계를 지키면서도 가벼운 수작업 질감과 넓은 여백으로 명확한 서사 흐름을 만들어, 한 페이지의 잘 편집된 개인 시각 일기처럼 완성합니다.

### 이런 상황에 적합합니다

- **한 장의 사진에 놓치고 싶지 않은 디테일이 여러 개일 때:** 인물, 동작, 사물, 환경의 단서가 함께 하나의 기억을 이야기해야 합니다.
- **콜라주를 원하지만 소재 진열처럼 보이고 싶지 않을 때:** 조각마다 위계와 방향, 호응이 있어야 하며, 균등한 분할이나 무작위 배치가 되어서는 안 됩니다.
- **부드러운 수작업 감성은 좋지만 유치해 보일까 걱정될 때:** 종이 오리기, 과슈, 파스텔, Riso 질감을 전문적인 여백과 편집 질서가 받쳐 줍니다.
- **유연한 결과물이 필요할 때:** 위아래, 좌우, 디자인 전용, 여러 비율, 네 기기용 배경화면을 지원하며 이미지 폴더도 일괄 처리할 수 있습니다.

### 간단한 시작 방법

처음부터 모든 옵션을 읽을 필요는 없습니다. Agent에 이미지를 보내고 다음과 같이 요청하세요.

> XXD Panel 061으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.

위의 예시로 시각 방향을 확인할 수 있습니다. 준비가 되면 [시작하기](#시작하기)로 이동하세요. 전체 모드, 크기, 매개변수는 뒤의 접이식 참고 자료에서 필요할 때 확인할 수 있습니다.
<!-- xxd-human-intro:end -->

<!-- xxd-panel-benefit:start -->
## 빠른 판단: XXD Panel 061이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 사진을 흩어지고 울리는 시각적 기억 조각으로 재구성합니다 |
| **한눈에 알아볼 특징** | 선택적 기억 · 다중 조각 내러티브 · 종이 컷 컬러 블록 · 힐링 컬러 팔레트 · 즉석 편집 및 레이아웃 |
...
```bash
git clone https://github.com/nevertoday/xxd-panel-061.git
mkdir -p ~/.codex/skills
ln -s "$(pwd)/xxd-panel-061" ~/.codex/skills/xxd-panel-061
```

`npx skills`로도 바로 설치할 수 있습니다:

```bash
npx skills add https://github.com/nevertoday/xxd-panel-061 --skill xxd-panel-061
```
...
Claude Code 사용자는 같은 폴더를 다음 위치에 연결할 수 있습니다: `~/.claude/skills/xxd-panel-061`. 설치 후 에이전트 세션을 다시 시작하세요.
...
전체 사양: [Skill 워크플로](SKILL.md) · [원본 스타일 자료](references/original-prompt/zh-CN.md) · [영문 런타임 어댑터](references/xxd-panel-061-prompt.en.md) · [중문 런타임 어댑터](references/xxd-panel-061-prompt.zh-CN.md)
...
**키워드:** 선택적 기억 · 다중 조각 내러티브 · 종이 컷 컬러 블록 · 힐링 컬러 팔레트 · 즉석 편집 및 레이아웃

Panel 061는 사진에서 가장 의미 있는 주제, 행동, 환경 단서 또는 은유 중 약 3~6개를 선택하고 페이퍼 커팅, 구아슈, 파우더 왁스, 리소그래프 및 스크린 프린팅 그래픽 언어를 사용하여 이를 가벼운 개인 시각적 일기의 한 페이지로 정리합니다.


## 입력을 고유한 결과로 바꾸는 방식

먼저 출처의 중심 기억을 식별한 다음 대략 3~6개의 주제, 행동, 환경 단서 또는 은유를 선택하여 관련 시각 기억 조각으로 전환합니다. 조각은 무작위로 흩어지지 않습니다. 넉넉한 네거티브 공간을 가로질러 읽을 수 있는 개인적인 이야기를 형성합니다.

```text
핵심 테마 및 내러티브 관계 식별 → 3~6개의 기억 조각 선택 → 잘라낸 종이, 구아슈, 왁스 파스텔 및 Riso 언어를 통해 단순화 → 규모, 방향 및 간격을 통해 에코 구축 → 소스에서 치유 팔레트 번역 → 희소 사본이 기억 단서로 작용하도록 함
```

## 완성 스타일을 알아보는 특징

- 대략 3~6개의 조각이 임의의 개체 인벤토리가 되는 대신 하나의 공유된 이야기를 전달합니다.
- 컷 페이퍼 블록, 구아슈, 왁스 파스텔, 리소그래프, 스크린 프린트 텍스처가 가벼운 수제 언어를 만들어냅니다.
- 레이아웃은 자연스럽게 느껴지지만 스케일 대비, 대각선 에코, 포지티브-네거티브 모양 및 밀도를 사용하여 안정적인 읽기 경로를 형성합니다.
- 지면은 흰색에 가깝게 유지되며 소스 온도에 따라 부드럽게 이동합니다. 넉넉한 공간이 모든 조각을 숨쉬게 해줍니다.
- 복사는 정보 메뉴를 형성하기보다는 이미지를 연결하는 흩어져 있는 관찰 메모나 짧은 문구처럼 작동합니다.

미적 제약과 금지 항목은 [중국어 원본 프롬프트](references/original-prompt/zh-CN.md)에만 있습니다. Skill과 런타임 어댑터는 이번 전달 변수만 처리합니다. [Skill 워크플로](SKILL.md) · [영문 런타임 어댑터](references/xxd-panel-061-prompt.en.md)
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 061의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
```text
/xxd-panel-061 photo.jpg --mode top-bottom,design-only --size auto,3:4,9:16 --text prompt --locale ja-JP
```
...
```text
/xxd-panel-061 photo.jpg --prefs last
/xxd-panel-061 photo.jpg --prefs edit
/xxd-panel-061 photo.jpg --prefs new
```
...
/xxd-panel-061 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-061 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-061 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR

# 연결형 4종 배경화면: 기준 이미지 후 기기별 재구성
/xxd-panel-061 photo.jpg --mode wallpaper-pack --wallpaper linked --text none

# 독립형 배경화면: 기기별 정확한 해상도 지정
/xxd-panel-061 photo.jpg --mode wallpaper-pack --wallpaper independent --wallpaper-size phone=1440x3200,ipad=2048x2732,desktop=3840x2160,watch=1024x1024 --text none

# 원본 이미지 비율 따르기
/xxd-panel-061 photo.jpg --mode design-only --size source --text none

# 정사각형·세로·가로 완성 구도를 각각 생성
/xxd-panel-061 photo.jpg --mode design-only --size 1:1,3:4,16:9 --text none

# 사용자 비율과 정확한 픽셀을 함께 지정
/xxd-panel-061 photo.jpg --mode design-only --size 11:14,2160x3840,3840x2160 --text none

# 원본 프롬프트가 문구를 만들고 언어만 제한
/xxd-panel-061 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-061 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-061 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 061 적용, 공통 설정은 한 번만 확정
/xxd-panel-061 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR

# 반복 매개변수도 누적하며 지정 루트 아래로 출력
/xxd-panel-061 photo.jpg --mode top-bottom --mode left-right --size 3:4 --size 16:9 --text none --out ./deliveries
```
