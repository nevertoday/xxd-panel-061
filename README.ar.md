...
# 🦁 XXD Panel 061｜دفتر الذاكرة البصرية

### إعادة تنظيم الصور إلى أجزاء متناثرة ومتكررة من الذاكرة المرئية
...
في صورة من رحلة أو لقاء أو لحظة يومية، نادراً ما يكون ما يصعب التخلي عنه موضوعاً واحداً فقط؛ فقد تكون حركة أو غرض صغير أو جزء من المكان أو علاقة بين الأشخاص جزءاً من الذاكرة. الرسم التقليدي الذي يركز على موضوع واحد قد يفقد هذه الإشارات، أما الكولاج المقسّم بالتساوي فقد يبدو كقائمة مواد.

يعيد **Panel 061** تنظيم أهم 3–6 إشارات في شذرات ذاكرة متناثرة لكنها مترابطة. يحافظ على العلاقات الأساسية في الصورة، ويستخدم ملمساً يدوياً خفيفاً ومساحات فارغة واسعة لبناء مسار سردي واضح، فتبدو النتيجة كصفحة محررة بعناية من يوميات بصرية شخصية.

### استخدمه في هذه الحالات

- **عندما تضم الصورة تفاصيل كثيرة لا تريد خسارتها:** يجب أن تروي الشخصيات والحركات والأغراض وإشارات المكان الذاكرة نفسها معاً.
- **عندما تريد كولاجاً لا يبدو كعرض للمواد:** تحتاج الشذرات إلى تراتبية واتجاه وروابط متبادلة، لا إلى تقسيمات متساوية أو توزيع عشوائي.
- **عندما تحب اللمسة اليدوية الرقيقة لكنك تخشى أن تبدو طفولية:** تدعم المساحات المدروسة والنظام التحريري ملمس قصاصات الورق والغواش والباستيل وطباعة Riso.
- **عندما تحتاج إلى تسليم مرن:** يدعم التكوين الرأسي من أعلى إلى أسفل، والتكوين الأفقي من اليسار إلى اليمين، والتصميم المستقل، والنسب المتعددة، وخلفيات أربعة أجهزة، كما يعالج مجلدات الصور دفعة واحدة.

### طريقة بسيطة للبدء

لا تحتاج إلى مراجعة كل الخيارات أولاً. أرسل صورة إلى الوكيل واطلب:

> استخدم XXD Panel 061 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.

يمكنك استخدام النماذج أعلاه لتأكيد الاتجاه البصري. وعندما تكون مستعداً، انتقل مباشرة إلى [البدء](#البدء). تبقى الأوضاع والمقاسات والمعاملات الكاملة متاحة في المرجع القابل للتوسيع أدناه عند الحاجة.
<!-- xxd-human-intro:end -->
...
** الكلمات الرئيسية: ** الذاكرة الانتقائية · السرد متعدد الأجزاء · كتل الألوان المقطوعة بالورق · لوحة الألوان العلاجية · التحرير والتخطيط المرتجل

يختار Panel 061 حوالي 3-6 من الموضوعات أو الإجراءات أو القرائن البيئية أو الاستعارات الأكثر أهمية من الصور، ويستخدم قطع الورق، والغواش، وبودرة الشمع، والريسوغراف، واللغة الرسومية لطباعة الشاشة لتنظيمها في صفحة من المذكرات المرئية الشخصية الخفيفة.

<!-- xxd-panel-benefit:start -->
## تحقق سريع: هل XXD Panel 061 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | إعادة تنظيم الصور إلى أجزاء متناثرة ومتكررة من الذاكرة المرئية |
| **السمات التي تُعرف من النظرة الأولى** | الذاكرة الانتقائية · السرد متعدد الأجزاء · كتل الألوان المقطوعة بالورق · لوحة الألوان العلاجية · التحرير والتخطيط المرتجل |
...
فهو يحدد أولاً الذاكرة المركزية للمصدر، ثم يختار ما يقرب من ثلاثة إلى ستة مواضيع، أو أفعال، أو أدلة بيئية، أو استعارات، ويحولها إلى أجزاء من الذاكرة المرئية ذات الصلة. القطع ليست متناثرة عشوائيا. إنها تشكل رواية خاصة قابلة للقراءة عبر مساحة سلبية سخية.

```text
تحديد الموضوع الأساسي والعلاقة السردية ← تحديد ثلاث إلى ست أجزاء من الذاكرة ← التبسيط من خلال الورق المقطوع، والغواش، والباستيل الشمعي، ولغة الريسو ← إنشاء أصداء من خلال المقياس والاتجاه والمسافات ← ترجمة لوحة معالجة من المصدر ← دع النسخة المتناثرة تعمل كدليل للذاكرة
```

## السمات التي تميّز الأسلوب النهائي

- ما يقرب من ثلاثة إلى ستة أجزاء تحكي قصة مشتركة واحدة بدلاً من أن تصبح مخزونًا عشوائيًا للأشياء.
- تخلق كتل الورق المقطوعة والغواش والباستيل الشمعي والريسوغراف والملمس المطبوع على الشاشة لغة يدوية خفيفة.
- يبدو التصميم عفويًا ولكنه يستخدم تباين المقياس والأصداء القطرية والأشكال الإيجابية والسلبية والكثافة لتشكيل مسار قراءة ثابت.
- تظل الأرض شبه بيضاء وتتغير بلطف مع درجة حرارة المصدر؛ مساحة واسعة تحافظ على كل جزء يتنفس.
- تعمل النسخة مثل ملاحظات ملاحظة متناثرة أو عبارات قصيرة تربط الصور بدلاً من تشكيل قائمة معلومات.

توجد القيود الجمالية وقواعد الرفض فقط في [الموجّه الصيني الأصلي](references/original-prompt/zh-CN.md)، بينما يتولى الـ Skill ومهايئ التشغيل متغيرات التسليم فقط. [سير عمل Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-061-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 061. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-061 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-061 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-061 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-061 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-061 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 061 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-061 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-061`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-061-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-061-prompt.zh-CN.md)
...
| **[xxd-panel-061](https://github.com/nevertoday/xxd-panel-061)** | شكل أسود رئيسي · فراغ هائل · تلاشي هالف تون · تأمل زِنّي · شظايا فكر |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–061) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
